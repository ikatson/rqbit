...
export const Footer: React.FC<{}> = () => {
  ...
  return (
    <div className="sticky bottom-0 bg-surface-raised/80 backdrop-blur text-nowrap text-sm font-medium text-text-secondary flex gap-x-1 lg:gap-x-5 justify-evenly flex-wrap">
      <FooterPiece>
